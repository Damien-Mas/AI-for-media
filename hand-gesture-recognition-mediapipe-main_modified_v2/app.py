    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                if hand_sign_id == 0 and keypoint_classifier_labels.get('0'):
                    play_sound_threaded(keypoint_classifier_labels['0'])
                elif hand_sign_id == 1 and keypoint_classifier_labels.get('1'):
                    play_sound_threaded(keypoint_classifier_labels['1'])
                elif hand_sign_id == 2 and keypoint_classifier_labels.get('2'):
                    play_sound_threaded(keypoint_classifier_labels['2'])
                elif hand_sign_id == 3 and keypoint_classifier_labels.get('3'):
                    play_sound_threaded(keypoint_classifier_labels['3'])
                elif hand_sign_id == 4 and keypoint_classifier_labels.get('4'):
